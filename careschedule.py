...
def get_patient(patient_id: str, request: Request):
    ...
    return {
        "id": patient_id_db,  # <-- Correctly return the patient's ID
        "name": name,
        "age": age,
        "gender": gender,
        "diseaseName": disease,
...
@app.post("/patient/overall/{patient_id}")
...
"""
    ...
    return JSONResponse(content={"suggestion": suggestion_text, "providers": providers, "patientInfo": patient_info})
